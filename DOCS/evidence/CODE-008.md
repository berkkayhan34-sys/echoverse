...
| `npm exec -- vitest run project/apps/desktop/electron/updater-validation.test.ts`      | Node 22, Vitest                                  | `pass`                   | Four updater boundary tests passed, including known-good-version preservation and invalid-version rejection during failure recovery.                              |
