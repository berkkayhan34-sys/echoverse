...
The authoritative Render deployment manifest is `project/apps/server/render.yaml`. The
`project/render.yaml` file is legacy metadata until it is explicitly retired in a later
