...
| Desktop client               | `project/apps/desktop/` Electron shell and renderer                      | `project/apps/desktop/electron/main.cjs`, `project/apps/desktop/electron/preload.cjs`, `project/apps/desktop/electron/bridge.cjs`, and `project/apps/desktop/src/main.tsx` | `project/apps/desktop/electron/bridge.test.ts`, `project/apps/desktop/electron/updater-validation.test.ts`, and `project/tests/e2e/smoke.spec.ts`; installer smoke coverage is pending | [`desktop component reference`](../components/desktop.md)         |
...
| Shared UI                    | `project/packages/shared-ui/` browser-safe primitives                    | `project/packages/shared-ui/src/index.tsx`                                                                                                                                 | Renderer build/typecheck coverage; focused component tests remain roadmap work                                                                                                         | [`shared-ui component reference`](../components/shared-ui.md)     |
