...
| Server persistence           | `apps/server/src/persistence/` and `apps/server/db/`                                                                                | `apps/server/src/persistence/migrations.ts`, `sqlite.ts`, and `sqlite-migrations.ts`                   | `apps/server/src/persistence/sqlite.test.ts`; PostgreSQL coverage in `database.dbtest.ts` | [`apps/server/README.md`](../../apps/server/README.md)                   |
